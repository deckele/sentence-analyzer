...
export const Spinner = () => {
    return (
        <svg className="spinner" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="200px" height="200px" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            <rect fill="#e15b64" x="55" y="55" width="30" height="30" rx="3" ry="3">
            ...
            </rect><rect fill="#f8b26a" x="42.8682" y="15" width="30" height="30" rx="3" ry="3">
            ...
            </rect><rect fill="#abbd81" x="15" y="55" width="30" height="30" rx="3" ry="3">
